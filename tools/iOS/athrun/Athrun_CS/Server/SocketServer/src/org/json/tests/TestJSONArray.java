...
public class TestJSONArray extends TestCase {
	...
	public void testOptJSONObject() {
		try {
			jsonarray = new JSONArray();
			jsonarray.put(new JSONObject().put("abc", "123"));
			assertEquals("{\"abc\":\"123\"}", jsonarray.optJSONObject(0)
					.toString());
		} catch (JSONException e) {
			fail(e.getMessage());
		}
	...
	public void testToJSONObject() {
		try {
			...
			jsonarray.put(new JSONArray().put("abc"));
			jsonarray.put(new JSONObject().put("abc", "123"));
			JSONArray names = new JSONArray(new String[] { "bdd", "fdsa",
					"fds", "ewre", "rer", "gfs" });
			assertEquals(
	...
	public void testGetJSONObject() {
		try {
			jsonarray = new JSONArray();
			jsonarray.put(new JSONObject().put("abc", "123"));
			assertEquals("{\"abc\":\"123\"}", jsonarray.getJSONObject(0)
					.toString());
		} catch (JSONException e) {
			fail(e.getMessage());
		}
	...
	public void testPut_CollectionAndSpecificIndex() {
		try {
			...
			jsonarray.put(0, a);
			jsonarray.put(1, b);
			assertEquals(new JSONArray(a).toString(), jsonarray.get(0)
					.toString());
			assertEquals(new JSONArray(b).toString(), jsonarray.get(1)
					.toString());
			jsonarray.put(0, c);
			assertEquals(new JSONArray(c).toString(), jsonarray.get(0)
					.toString());
			assertEquals(new JSONArray(b).toString(), jsonarray.get(1)
					.toString());
			jsonarray.put(8, d);
			assertEquals(new JSONArray(d).toString(), jsonarray.get(8)
					.toString());
			assertEquals(JSONObject.NULL, jsonarray.get(2));
			assertEquals(JSONObject.NULL, jsonarray.get(3));
			assertEquals(JSONObject.NULL, jsonarray.get(4));
	...
	public void testPut_MapAndSpecificIndex() {
		try {
			...
			jsonarray.put(0, a);
			jsonarray.put(1, b);
			assertEquals(new JSONObject(a).toString(), jsonarray.get(0)
					.toString());
			assertEquals(new JSONObject(b).toString(), jsonarray.get(1)
					.toString());
			jsonarray.put(0, c);
			assertEquals(new JSONObject(c).toString(), jsonarray.get(0)
					.toString());
			assertEquals(new JSONObject(b).toString(), jsonarray.get(1)
					.toString());
			jsonarray.put(8, d);
			assertEquals(new JSONObject(d).toString(), jsonarray.get(8)
					.toString());
			assertEquals(JSONObject.NULL, jsonarray.get(2));
			assertEquals(JSONObject.NULL, jsonarray.get(3));
			assertEquals(JSONObject.NULL, jsonarray.get(4));
